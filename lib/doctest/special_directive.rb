module DocTest
  class SpecialDirective < Lines
    ...
    # >> s = DocTest::SpecialDirective.new(["doctest: Testing Stuff", "Other Stuff"])
    # >> s.name
    # => "doctest:"
    #
    # doctest: "it:" is a valid directive
    # >> s = DocTest::SpecialDirective.new(["it: should test stuff"])
    # >> s.name
    # => "it:"
    def name
    ...
    # >> s = DocTest::SpecialDirective.new(["doctest: Testing Stuff", "  On Two Lines"])
    # >> s.value
    # => "Testing Stuff\nOn Two Lines"
    #
    # doctest: "it" should also work as a directive
    # >> s = DocTest::SpecialDirective.new(["it: should do something"])
    # >> s.value
    # => "should do something"
    def value
